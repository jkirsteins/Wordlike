    ...
    static var previews: some View {
        ...
        VStack {
            ...
            KeyboardHints_TestView(state: GameState(
                initialized: true, 
                expected: TurnAnswer(word: "fuels", day: 1, locale: "en"), rows: [
        ...
        VStack {
            ...
            KeyboardHints_TestView(state: GameState(
                initialized: true, 
                expected: TurnAnswer(word: "holly", day: 1, locale: "en"), rows: [
        ...
        VStack {
            ...
            ForEach(["lv", "fr"], id: \.self) {
                ...
                VStack {
                    ...
                    KeyboardHints_TestView(state: GameState(
                        initialized: true, 
                        expected: TurnAnswer(word: "fuels", day: 1, locale: locale), rows: [
